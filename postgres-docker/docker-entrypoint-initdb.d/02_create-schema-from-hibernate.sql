-- content has been manually taken over from the file target/hibernate3/sql/ 
-- after creating the schema via 'mvn hibernate3:hbm2ddl'

-- todo : automate schema creation for docker image creation
...
\c sportrait sportrait
    ...
    alter table EventRunners 
        add constraint FK9C5D3F69CC92EA5 
        foreign key (eventID) 
        references GenericLevels;
    ...
    alter table UserProfiles2UserRoles 
        add constraint FKB11BF8551B2B4F49 
