    ...
    alter table GenericLevels 
        add constraint FK28FFFE0678B12B5E 
        foreign key (albumId) 
    ...
    create index GenericLevel_UserProfile_INDEX on Photographers (userProfileId);

    alter table Photographers 
        add constraint FK393AB96AECB2BF8C 
    ...
    create sequence sequence_photographerId;
