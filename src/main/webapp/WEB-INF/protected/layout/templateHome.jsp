...
<head>
    ...
    --%>
    <c:if test="${Registry._DevEnv}"><tiles:insert attribute="googleTagManagerHeadSnippetDev" ignore="true"/></c:if>


    <c:if test="${Registry._IntEnv}"><tiles:insert attribute="googleTagManagerHeadSnippetInt" ignore="true"/></c:if>


    <c:if test="${Registry._ProdEnv}"><tiles:insert attribute="googleTagManagerHeadSnippetProd" ignore="true"/></c:if>
    ...
    <body id="bodyHome">
    <%--
        START Google Tag Manager Snippt Body
    --%>
