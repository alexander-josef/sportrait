...
<div class="content600">
    ...
    <h2><html:img page="/images/step_1.gif" alt="Schritt 1"/></h2>

    <p>Du kennst einen Anlass, bei dem du Sportfotos schiessen willst, oder findest auf SPORTRAIT einen Anlass, dessen
        Austragungsort in deiner
        Reichweite liegt. Ist ein dir bekannter Anlass bei SPORTRAIT noch nicht eingetragen, so melde ihn bei SPORTRAIT
        an, und
        schon kannst Du auch zu diesem Anlass Fotos publizieren.<br/>
        Du besuchst den Anlass und schiesst Fotos von den Athletinnen und Athleten.</p>
    ...
    <!--
        ...
        <a href="#"><html:img page="/images/buttons/bt_registerNow_de.gif" alt="anmelden"/></a>
        </h2>
