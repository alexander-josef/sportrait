...
<meta name="twitter:creator" content="@sportrait123">
...
<meta name="twitter:image" content="https://${display.applicationEnvironment}-sportrait.imgix.net/fine-images/${display.albumFromPhoto.genericLevelId}/fine/${display.displayPhoto.filename}?w=1000&h=500&fit=crop&crop=top%2Cleft">
