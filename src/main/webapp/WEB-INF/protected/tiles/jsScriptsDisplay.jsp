...
<script>
    ...
    function changeHTMLafterSlideTransition() {
        ...
        // document.getElementById("metaTagUrl").setAttribute("content", "http://int.sportrait.com/display/32047/display.html"); // Test - for facebook sharing, will it work to change the meta tag?
