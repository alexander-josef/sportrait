...
<ul class="tabnavigation">
    ...
    <c:if test="${clientInSession!=null}">
        <li><html:link action="/photographer/main-zul">
            <html:img page="/images/tabs/tab_toMyAccount_de.gif" alt="mein Konto"/></html:link>
        </li>
    </c:if>
    <c:if test="${clientInSession!=null}">
        <li>
    ...
    <li><html:img page="/images/tabs/ON/tab_shoppingcart_de.gif" alt="warenkorb"/></li>
    <li><html:link action="/showCategory"><html:img page="/images/tabs/tab_fotos_de.gif" alt="fotos"/></html:link></li>
</ul>