...
<div class="content">
    ...
    -->
    <h2 class="orange"><br/>Bestätigung der Registrierung</h2>
   <p>Wir haben Deine Registrierung erhalten.<br/>
        Zurzeit läuft SPORTRAIT für Fotografen noch als Beta-Version. Sobald der Service für dich bereit steht, werden
       wir dich per E-Mail kontaktieren und dir Login und Passwort zustellen.
   </p>
</div>
